...
#include "action_interfaces/action/detail/fleet_management__rosidl_typesupport_fastrtps_c.h"
...
using _FleetManagement_Goal__ros_msg_type = action_interfaces__action__FleetManagement_Goal;
...
size_t get_serialized_size_action_interfaces__action__FleetManagement_Goal(
  const void * untyped_ros_message,
...
static uint32_t _FleetManagement_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__FleetManagement_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__FleetManagement_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _FleetManagement_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__FleetManagement_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_Goal)() {
...
using _FleetManagement_Result__ros_msg_type = action_interfaces__action__FleetManagement_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__FleetManagement_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FleetManagement_Result__ros_msg_type * ros_message = static_cast<const _FleetManagement_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__FleetManagement_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__FleetManagement_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _FleetManagement_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__FleetManagement_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_Result)() {
...
using _FleetManagement_Feedback__ros_msg_type = action_interfaces__action__FleetManagement_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__FleetManagement_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FleetManagement_Feedback__ros_msg_type * ros_message = static_cast<const _FleetManagement_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__FleetManagement_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__FleetManagement_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _FleetManagement_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__FleetManagement_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_Feedback)() {
...
// already included above
// #include "action_interfaces/action/detail/fleet_management__functions.h"  // goal
...
using _FleetManagement_SendGoal_Request__ros_msg_type = action_interfaces__action__FleetManagement_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__FleetManagement_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FleetManagement_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _FleetManagement_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_action_interfaces__action__FleetManagement_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__FleetManagement_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__FleetManagement_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_action_interfaces__action__FleetManagement_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _FleetManagement_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__FleetManagement_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_SendGoal_Request)() {
...
using _FleetManagement_SendGoal_Response__ros_msg_type = action_interfaces__action__FleetManagement_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__FleetManagement_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FleetManagement_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _FleetManagement_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__FleetManagement_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__FleetManagement_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _FleetManagement_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__FleetManagement_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_SendGoal)() {
...
using _FleetManagement_GetResult_Request__ros_msg_type = action_interfaces__action__FleetManagement_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__FleetManagement_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FleetManagement_GetResult_Request__ros_msg_type * ros_message = static_cast<const _FleetManagement_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__FleetManagement_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__FleetManagement_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _FleetManagement_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__FleetManagement_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_GetResult_Request)() {
...
// already included above
// #include "action_interfaces/action/detail/fleet_management__functions.h"  // result
...
using _FleetManagement_GetResult_Response__ros_msg_type = action_interfaces__action__FleetManagement_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__FleetManagement_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FleetManagement_GetResult_Response__ros_msg_type * ros_message = static_cast<const _FleetManagement_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_action_interfaces__action__FleetManagement_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__FleetManagement_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__FleetManagement_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_action_interfaces__action__FleetManagement_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _FleetManagement_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__FleetManagement_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_GetResult)() {
...
// already included above
// #include "action_interfaces/action/detail/fleet_management__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _FleetManagement_FeedbackMessage__ros_msg_type = action_interfaces__action__FleetManagement_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t get_serialized_size_action_interfaces__action__FleetManagement_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FleetManagement_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _FleetManagement_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_action_interfaces__action__FleetManagement_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_action_interfaces__action__FleetManagement_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_action_interfaces
size_t max_serialized_size_action_interfaces__action__FleetManagement_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_action_interfaces__action__FleetManagement_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _FleetManagement_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_action_interfaces__action__FleetManagement_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, action_interfaces, action, FleetManagement_FeedbackMessage)() {
