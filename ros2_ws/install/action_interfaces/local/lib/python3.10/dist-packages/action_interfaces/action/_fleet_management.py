    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'action_interfaces.action.FleetManagement_Goal')
            logger.debug(
...
class Metaclass_FleetManagement_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.FleetManagement_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_FleetManagement_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.FleetManagement_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FleetManagement_SendGoal_Request(metaclass=Metaclass_FleetManagement_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'action_interfaces/FleetManagement_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'FleetManagement_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_interfaces.action._fleet_management import FleetManagement_Goal
...
class Metaclass_FleetManagement_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.FleetManagement_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from action_interfaces.action import _fleet_management
...
class FleetManagement_SendGoal(metaclass=Metaclass_FleetManagement_SendGoal):
    from action_interfaces.action._fleet_management import FleetManagement_SendGoal_Request as Request
    from action_interfaces.action._fleet_management import FleetManagement_SendGoal_Response as Response
...
class FleetManagement_GetResult_Response(metaclass=Metaclass_FleetManagement_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'action_interfaces/FleetManagement_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'FleetManagement_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from action_interfaces.action._fleet_management import FleetManagement_Result
...
class Metaclass_FleetManagement_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.FleetManagement_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FleetManagement_GetResult(metaclass=Metaclass_FleetManagement_GetResult):
    from action_interfaces.action._fleet_management import FleetManagement_GetResult_Request as Request
    from action_interfaces.action._fleet_management import FleetManagement_GetResult_Response as Response
...
class Metaclass_FleetManagement_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.FleetManagement_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FleetManagement_FeedbackMessage(metaclass=Metaclass_FleetManagement_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'action_interfaces/FleetManagement_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['action_interfaces', 'action'], 'FleetManagement_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from action_interfaces.action._fleet_management import FleetManagement_Feedback
...
class Metaclass_FleetManagement(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'action_interfaces.action.FleetManagement')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class FleetManagement(metaclass=Metaclass_FleetManagement):
    ...
    from action_interfaces.action._fleet_management import FleetManagement_Goal as Goal
    # The result message defined in the action definition.
    from action_interfaces.action._fleet_management import FleetManagement_Result as Result
    # The feedback message defined in the action definition.
    from action_interfaces.action._fleet_management import FleetManagement_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from action_interfaces.action._fleet_management import FleetManagement_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from action_interfaces.action._fleet_management import FleetManagement_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from action_interfaces.action._fleet_management import FleetManagement_FeedbackMessage as FeedbackMessage
